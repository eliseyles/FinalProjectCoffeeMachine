...
//            todo change to return optional
    ...
    @Override
    protected PreparedStatement buildUpdateByID(Connection connection, Drink drink) throws SQLException {
    ...
    @Override
    protected PreparedStatement buildDeleteById(Connection connection, Drink drink) throws SQLException {
